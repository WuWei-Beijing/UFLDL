...
save('onlineEx_step2.mat', 'sae1OptTheta');
end
load('step1.mat');
...
save('onlineEx_step3.mat', 'sae2OptTheta');
end
load('step2.mat');
...
save('onlineEx_step4.mat', 'saeSoftmaxOptTheta');
end
load('step3.mat');
% -------------------------------------------------------------------------
...
save('onlineEx_step5.mat', 'stackedAEOptTheta');
